      ...
      <ul style={{ listStyleType: 'none', padding: 0 }}>
        <li>
          ...
          <ul style={{ listStyleType: 'none', padding: 0, paddingLeft: '20px' }}>
            <li>
              <button style={{ marginBottom: '5px', width: '100%', textAlign: 'left', border: 'none' }}>Local Resoures</button>
            </li>
            <li>
              <button style={{ marginBottom: '5px', width: '100%', textAlign: 'left', border: 'none' }}>Workout Ideas</button>
            </li>
            <li>
              <button style={{ marginBottom: '5px', width: '100%', textAlign: 'left', border: 'none' }}>Making a Plan</button>
            </li>
          </ul>
        </li>
        <li>
